...
public class FindItemTest {
    ...
    void testFindByStore() {
        ...
        List<Item> returnedItem = findItem.findByStore(store.getId());
    ...
    void testFindByRating() throws ResourceNotFoundException {
        ...
        Item returnedItem = findItem.findByRating(rating.getId());
    ...
    void testFindById() throws ResourceNotFoundException {
        ...
        Item returnedItem = findItem.findById(itemId1);
        assertEquals(item1, returnedItem);
        assertNotNull(returnedItem);
