...
import com.boba.bobabuddy.framework.assembler.ItemResourceAssembler;
...
public class ItemControllerTest {
    ...
    void testUpdateItem() throws Exception {
        ItemDto item4 = new ItemDto("fruit tea", 7, 0);
        item2.setId(id1);
        item4.setId(id1);

        when(updateItem.updateItem(eq(item1), isA(ItemDto.class))).thenReturn(item2);
        when(findItem.findById(id1)).thenReturn(item1);
