...
@Component
public class RatingPointResourceAssembler extends SimpleIdentifiableRepresentationModelAssembler<RatingPoint> {
    RatingPointResourceAssembler() {
        super(RatingPointController.class);
    }

    @Override
    public void addLinks(EntityModel<RatingPoint> resource) {
        /**
         * Retain default links.
         */
        RatingPoint rating = Objects.requireNonNull(resource.getContent());
